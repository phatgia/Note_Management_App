...
export default function NoteLayout({ children, title }: PropsWithChildren<Props>) {
    ...
    return (
        <div className="flex h-screen w-full dark:bg-card overflow-hidden text-gray-800 font-sans">
            <Head title={title} />
            {/* Trái */}
                {/* Mobile */}
            <aside className="md:hidden border-r border-gray-300 flex flex-col h-full">
                <Link href="/home" className="cursor-pointer flex items-center justify-center border-b border-gray-300 pb-10.5 px-4 py-9">
                ...
                <div className="flex-1 overflow-y-auto px-4">
                    ...
                    <Link href="/home" className={url === '/home' ? "flex items-center justify-center bg-orange-200 dark:bg-card dark:border border-orange-500 text-orange-600 px-3 py-2 rounded-lg cursor-pointer mb-1 hover:bg-orange-100 transition-colors" : "flex items-center justify-center bg-card dark:hover:bg-gray-100 text-orange-600 px-3 py-2 rounded-lg cursor-pointer mb-1 hover:bg-orange-100 transition-colors"}>
                    ...
                    <p className="flex justify-center text-xs font-semibold text-gray-400 mb-2 mt-4 uppercase tracking-wider">Nhãn</p>
                            ...
                            categories.map((cat: any) => {
                                ...
                                return (
                                    <Link 
                                        key={cat.id}
                                        href={`#`} 
                                        className="flex items-center justify-center gap-3 px-3 py-2 rounded-lg cursor-pointer transition-colors text-gray-600 hover:bg-gray-100 font-medium text-sm group"
                                    >
                ...
                <div className="p-4 border-t border-gray-300">
                    ...
                    <div className="flex items-center justify-between gap-2">
                        <div className="relative w-full" ref={menuRef}>
                            ...
                            {isMenuOpenMobile && (
                                <div className="absolute bottom-[calc(100%+0.5rem)] left-0 w-full bg-background border border-gray-300 rounded-xl shadow-lg py-1 z-50 overflow-hidden">
                                    <Link 
                                        ...
                                        className="flex items-center justify-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-orange-50 hover:text-orange-600 transition-colors"
                                    ...
                                    <button 
                                        ...
                                        className="cursor-pointer w-full flex items-center justify-center gap-3 px-4 py-3 text-sm text-red-600 hover:bg-red-50 transition-colors text-left"
                                    >
                            ...
                            <button onClick={()=>setIsMenuOpenMobile(!isMenuOpen)} className="flex items-center justify-between cursor-pointer w-full text-left p-2 rounded-lg transition-colors">
                ...
                {/* Desktop */}
            <aside className="w-64 hidden md:flex bg-sidebar border-r border-gray-300 flex flex-col h-full">
                {/* Logo */}
