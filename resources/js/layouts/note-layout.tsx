            ...
            <aside className="w-64 bg-white border-r border-gray-200 flex flex-col h-full">
                ...
                <div className="flex-1 overflow-y-auto px-4">
                    ...
                    <div className="flex items-center justify-between bg-orange-50 text-orange-600 px-3 py-2 rounded-lg cursor-pointer mb-1">
                        <div className="flex items-center gap-3">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" /></svg>
                ...
                <div className="p-4 border-t border-gray-200">
                    ...
                    <div className="flex items-center justify-between gap-2">
                        ...
                        <Link href="/settings/profile" className="flex items-center gap-3 flex-1 overflow-hidden group">
                        ...
                        <button onClick={() => router.post(logout())} className="p-2 text-gray-400 hover:bg-orange-50 hover:text-orange-500 rounded-lg transition-colors border border-transparent hover:border-orange-200 shrink-0">
