                ...
                <div className="relative z-10 flex flex-col justify-center h-full p-10 lg:p-14 xl:p-20 gap-8 text-white">
                    ...
                    <div>
                        <p className="text-gray-400 text-sm xl:text-base max-w-md">
                            Tạo, tổ chức và chia sẻ ghi chú của bạn một <br /> cách dễ dàng. Hỗ trợ hình ảnh, nhãn và cộng tác <br /> thời gian thực.
                        </p>
                    </div>
                    ...
                    <ul className="text-sm text-gray-400 space-y-4">
                        <li className="flex items-center gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-orange-500 shrink-0">
