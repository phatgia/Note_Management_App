    ...
    return (
        <NoteLayout title="Tất cả ghi chú">
            ...
            <div className="flex items-center gap-3 m-3 mt-6">
                ...
                <p className="font-semibold text-muted-foreground">Ghi chú của bạn</p>
                    ...
                    notes.map((note: any, index: number) => (
                        <div key={`${note.id}-${index}`} className="relative group">
                            ...
                            <button 
                                ...
                                className={`absolute z-20 p-2 rounded-full backdrop-blur-sm transition-all cursor-pointer 
                                    ${viewMode === 'grid' ? 'top-3 right-3' : 'top-1/2 -translate-y-1/2 right-4'}
