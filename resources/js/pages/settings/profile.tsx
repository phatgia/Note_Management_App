        ...
        <div className="w-full bg-[#F8F9FA] min-h-screen pb-12">
            ...
            <div className="bg-white border border-gray-300 rounded-xl shadow-sm overflow-hidden w-1/3 m-10">
                ...
                <form onSubmit={submitForm} className="space-y-6">
                    ...
                    <div className="p-6 border-b border-gray-300 space-y-6 flex justify-between">
                        ...
                        <div className=" flex items-center gap-6">
                            ...
                            {previewPhoto ? (
                                ...
                                <div className="w-16 h-16 rounded-full bg-orange-600 text-white flex items-center justify-center font-bold text-xl shadow-inner uppercase">
                            ...
                            <div className="flex flex-col gap-2">
                                <button 
                                    ...
                                    className="cursor-pointer bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors"
                                >
                                    Tải ảnh lên
                                </button>
                                ...
                                <button 
                                    ...
                                    className="cursor-pointer border border-red-200 text-red-500 hover:bg-red-50 text-sm font-medium px-4 py-2 rounded-lg transition-colors"
                                >
                                    Xoá ảnh
                                </button>
                            </div>
                    ...
                    {errors.avatar && <p className="text-red-500 text-sm px-6 -mt-2">{errors.avatar}</p>}
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="flex justify-end gap-4">
                            ...
                            <Transition
                                ...
                                leaveTo="opacity-0"
                            >
                                <p className="text-sm text-neutral-600 self-center">Đã lưu</p>
                            </Transition>
                        </div>
                    </div>
                </form>
